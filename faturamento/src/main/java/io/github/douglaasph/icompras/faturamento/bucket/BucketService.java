package io.github.douglaasph.icompras.faturamento.bucket;

import io.github.douglaasph.icompras.faturamento.config.props.MinioProps;
    ...
    public void upload(BucketFile file) {
        try {
            var object = PutObjectArgs
                    ...
                    .contentType(file.type().toString()) // applcation / pdf image / jpeg
                    .build();
