package io.github.douglaasph.icompras.faturamento.service;

import io.github.douglaasph.icompras.faturamento.bucket.BucketFile;
import io.github.douglaasph.icompras.faturamento.bucket.BucketService;
import io.github.douglaasph.icompras.faturamento.model.Pedido;
import io.github.douglaasph.icompras.faturamento.publisher.FaturamentoPublisher;
    ...
    public void gerar(Pedido pedido) {
        ...
        try {
            ...
            var file = new BucketFile(
                    nomeArquivo, new ByteArrayInputStream(byteArray), MediaType.APPLICATION_PDF, (long) byteArray.length
            );
